...
//               <p>Size:M</p>
//               </div>
//               <p className='mt-2'>Date:<span className='text-gray-700'>25, july,2024</span></p>
//             </div>
//            </div>
...
//               </div>
//                   <button className='border px-2  py-2 text-sm font-medium rounded-sm' >Track Order</button>
//                 </div>
//          </div>
